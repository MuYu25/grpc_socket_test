...
const (
	AccServer_QuerUserOnline_FullMethodName = "/protobuf.AccServer/QuerUserOnline"
...
type AccServerClient interface {
	// 查询用户是否在线
	QuerUserOnline(ctx context.Context, in *QueryUserOnlineReq, opts ...grpc.CallOption) (*QueryUserOnlineRsp, error)
	// 发送消息
...
func (c *accServerClient) QuerUserOnline(ctx context.Context, in *QueryUserOnlineReq, opts ...grpc.CallOption) (*QueryUserOnlineRsp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryUserOnlineRsp)
	err := c.cc.Invoke(ctx, AccServer_QuerUserOnline_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccServerServer interface {
	// 查询用户是否在线
	QuerUserOnline(context.Context, *QueryUserOnlineReq) (*QueryUserOnlineRsp, error)
	// 发送消息
...
func (UnimplementedAccServerServer) QuerUserOnline(context.Context, *QueryUserOnlineReq) (*QueryUserOnlineRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QuerUserOnline not implemented")
}
...
func _AccServer_QuerUserOnline_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryUserOnlineReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccServerServer).QuerUserOnline(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccServer_QuerUserOnline_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccServerServer).QuerUserOnline(ctx, req.(*QueryUserOnlineReq))
	}
...
var AccServer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "QuerUserOnline",
			Handler:    _AccServer_QuerUserOnline_Handler,
		},
		{
			MethodName: "SendMsg",
